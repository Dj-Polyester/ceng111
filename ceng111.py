...
listq[25]="Write -23,625 in IEEE 32 bit notation. Write as shown in parantheses(sign,exponent,mantissa). Also, do not write mantissa in 8 digits. Do not put other preceding zeros. $1,10000011,0111101"
p=0
import random
