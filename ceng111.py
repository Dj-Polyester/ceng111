...
listq[7]="In compilative approach, the programmer can locate errors easily.(T/F) $True"
...
listq[18]="The CPU works the fastest with integers among all data types.(T/F) $True"
