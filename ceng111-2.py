...
listq[6]="What is the machine that is used to crack the Enigma Code and by whom it is designed(Machine,Inventor)? $Collosus,Alan Turing"
...
listq[12]="In image processing, 7 bits are used to indicate RGB(Red-Green-Blue) levels seperately.(T/F) $True"
...
listq[29]="Ambigious instructions are disambiguated by decoder circuit.(T/F) $True"
